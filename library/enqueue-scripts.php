...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	function foundationpress_scripts() {
		...
		wp_enqueue_style( 'font-playfair', 'https://fonts.googleapis.com/css?family=Playfair+Display:400,700');

        wp_enqueue_style( 'slick-css', get_template_directory_uri() . '/src/assets/slick/slick.css');

        wp_enqueue_style( 'slick-theme', get_template_directory_uri() . '/src/assets/slick/slick-theme.css');
        ...
        wp_enqueue_script( 'slick-js', get_template_directory_uri() . '/src/assets/slick/slick.min.js');
